...
var module = "./lib/github-sponsors.es.js";
...
const printDonationMessage = (fundingConfig, thanksMessage = DEFAULT_THANKS_MESSAGE, donateMessage = DEFAULT_DONATE_MESSAGE) => {
  const dim = print('dim');
